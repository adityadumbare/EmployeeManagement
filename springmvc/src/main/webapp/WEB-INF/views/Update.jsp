<%@page import="com.jspiders.springmvc.pojo.ProductPOJO"%>
...
ProductPOJO employee = (ProductPOJO) request.getAttribute("emp");
List<ProductPOJO> employees = (List<ProductPOJO>) request.getAttribute("empList");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div align="center">
		...
		<table id="data">
			...
			<%
			for (ProductPOJO pojo : employees) {
			%>
			<tr>
				<td><%=pojo.getId()%></td>
				<td><%=pojo.getName()%></td>
